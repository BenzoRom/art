...
TEST(Arm64InstructionSetFeaturesTest, Arm64Features) {
  ...
  EXPECT_EQ(arm64_default_features->GetInstructionSet(), InstructionSet::kArm64);
  EXPECT_TRUE(arm64_default_features->Equals(arm64_features.get()));
  EXPECT_STREQ("a53", arm64_default_features->GetFeatureString().c_str());
  ...
  EXPECT_EQ(cortex_a57_crc_features->GetInstructionSet(), InstructionSet::kArm64);
  ...
  EXPECT_EQ(cortex_a73_crc_features->GetInstructionSet(), InstructionSet::kArm64);
  ...
  EXPECT_EQ(cortex_a35_crc_features->GetInstructionSet(), InstructionSet::kArm64);
